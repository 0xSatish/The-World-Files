      ...
      {members.map((member, index) => {
        ...
        return (
          ...
          >
            ...
            <div
              className={`absolute -inset-1 rounded-full bg-gradient-to-r from-[#63D8F2] via-[#8668D9] to-[#E76B9B] opacity-0 transition-opacity duration-300 blur-[2px] ${
                isHovered ? "opacity-90" : "group-hover:opacity-60"
              }`}
            />
